...
public final class LegacyWrapperActivity extends Activity {
    ...
    private final class Client extends WebViewClient {
        ...
        @Override public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
            if (request.isForMainFrame()) Toast.makeText(LegacyWrapperActivity.this, "Load failed: " + error.getDescription(), Toast.LENGTH_LONG).show();
        }
        @Override public boolean onRenderProcessGone(WebView view, RenderProcessGoneDetail detail) {
            Toast.makeText(LegacyWrapperActivity.this, "The editor renderer stopped. Reloading…", Toast.LENGTH_LONG).show();
    ...
    private final class ChromeClient extends WebChromeClient {
        ...
        @Override public void onShowCustomView(View view, CustomViewCallback callback) {
            ...
            ImmersiveMode.apply(LegacyWrapperActivity.this);
        }
    ...
    private final class Downloads implements DownloadListener {
        @Override public void onDownloadStart(String url, String userAgent, String disposition, String mime, long length) {
            ...
            try {
                ...
                Toast.makeText(LegacyWrapperActivity.this, "Downloading " + name, Toast.LENGTH_LONG).show();
    ...
    public final class SaveBridge {
        ...
        @JavascriptInterface public boolean close(String id) {
            ...
            try { stream.flush(); stream.close(); mainHandler.post(() -> Toast.makeText(LegacyWrapperActivity.this, "Vizzy export saved.", Toast.LENGTH_LONG).show()); return true; }
            catch (IOException e) { return false; }
        }
        @JavascriptInterface public void abort(String id, String reason) {
            closeQuietly(saveStreams.remove(id));
            mainHandler.post(() -> Toast.makeText(LegacyWrapperActivity.this, "Export cancelled.", Toast.LENGTH_SHORT).show());
        }
    }
